...
| bp_systolic, bp_diastolic | INTEGER (nullable) | คอลัมน์เก่าที่เก็บไว้เพื่อรองรับข้อมูลเดิม |
| heart_rate | INTEGER (nullable) | คอลัมน์เก่าที่เก็บไว้เพื่อรองรับข้อมูลเดิม |
| body_temp | REAL (nullable) | คอลัมน์เก่าที่เก็บไว้เพื่อรองรับข้อมูลเดิม |
| symptoms | TEXT | อาการ / ประวัติการรักษาที่เลือก |
| medical_history | TEXT | อาการ / ประวัติการรักษาที่เลือก |
| created_at | TEXT | ISO timestamp |
...
3. เลือก **อาการ / ประวัติการรักษา** (ถ้ามี) จาก popup เลือกได้หลายข้อ ค่าเริ่มต้นคือ **ไม่มี**
4. ไม่ต้องกรอกความดัน อัตราการเต้นหัวใจ หรืออุณหภูมิร่างกาย
...
- คำนวณจาก: BMI, อายุ, อาการ / ประวัติการรักษา
...
- ถ้าไม่ล็อกอิน → ยังประเมินได้แบบ guest แต่ดูประวัติไม่ได้
- ถ้าล็อกอิน → ดูประวัติการประเมินของบัญชีตัวเองได้
